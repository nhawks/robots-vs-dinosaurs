...
class Battlefield:
    ...
    def battle(self):  # void
        while (
            len(self.herd.dinosaurs) != 0
            and len(self.fleet.robots) != 0
        ):
    ...
    def pick_dino_attack(self, dinosaur):
        ...
        attack_info = DinoAttacks(
            input(
                f"Dinosaur Attacks {self.herd.herd_attacks}\n"
                "Please enter the name of the attack you'd like to choose: "
            ).lower()
        )
    ...
    def dinosaur_turn(self, dinosaur):  # void
        ...
        print(
            f"You chose: {dinosaur.dinosaur_name.upper()}\n"
    ...
    def robot_turn(self, robot):  # void
        ...
        print(
            f"You chose: {robot.robot_name.upper()}\n"
    ...
    def show_dinosaur_info(self, dinosaur):
        self.dinosaur = dinosaur
        print(
            f"{self.herd.dinosaurs.index(dinosaur)} - {dinosaur.dinosaur_name} | "
    ...
    def show_robot_info(self, robot):
        self.robot = robot
        print(
            f"{self.fleet.robots.index(robot)} - {robot.robot_name} | "
